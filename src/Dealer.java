...
public class Dealer implements Serializable{
    ...
    public void serialize(Inventory e){
        try {
            File file = FileUtils.getFile("C:\\Users\\Pratik\\IdeaProjects\\HW2\\src.ser", "dealer1.ser");
            byte[] data = SerializationUtils.serialize(e);
            FileUtils.writeByteArrayToFile(file, data);
            System.out.printf("Serialized data is saved at C:\\Users\\Pratik\\IdeaProjects\\src.ser");
        } catch (IOException i) {
            i.printStackTrace();
        }
    }
